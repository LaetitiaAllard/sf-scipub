...
class ScienceController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_science_show', array('id' => $science->getId()));
        }
    ...
    public function editAction(Request $request, Science $science)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_science_edit', array('id' => $science->getId()));
        }
    ...
    public function deleteAction(Request $request, Science $science)
    {
        ...
        return $this->redirectToRoute('app_admin_science_index');
    }
    ...
    private function createDeleteForm(Science $science)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('app_admin_science_delete', array('id' => $science->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
